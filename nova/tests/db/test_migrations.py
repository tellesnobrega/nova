...
class TestNovaMigrations(BaseWalkMigrationTestCase, CommonTestsMixIn):
    ...
    def _check_266(self, engine, data):
        domain_quota_usages = oslodbutils.get_table(engine,
                                                    'domain_quota_usages')
        domain_reservations = oslodbutils.get_table(engine,
                                                    'domain_reservations')
        domain_quotas = oslodbutils.get_table(engine, 'domain_quotas')
